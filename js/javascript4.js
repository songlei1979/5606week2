...
function calculate() {
    ...
    var num1 = num1Input.value; //var means define the after word to be a variable, in one file, you only do this once
    var num2 = num2Input.value; // parseFloat will convert your string to double
